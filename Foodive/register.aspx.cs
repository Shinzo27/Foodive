...
namespace Foodive
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-0VBFBDN\\SQLEXPRESS;Initial Catalog=dbFoodive;Integrated Security=True");
        ...
        protected void btnOtp_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    String emailbody = "Hello " + username + "! Here is your One Time Password For Registration : <b>" + sendOtp + "</b>.<br><br>Thank You For Interacting With Foodive!!<br><br> Have A Good Food!";
                    MailMessage mm = new MailMessage("20bmiit070@gmail.com", toEmail);
                    mm.Body = emailbody;
                    mm.IsBodyHtml = true;
                    ...
                    {
                        UserName = "20bmiit070@gmail.com",
                        Password = "hicbjxwvodjftuky"
                    };
                    SMTP.EnableSsl = true;
                    SMTP.Send(mm);
